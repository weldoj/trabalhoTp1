...
public class TelaEstoque extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtValidade, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        lblTituloTabela.setText("Tipo de Alimento Atual: ");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnltabela, javax.swing.GroupLayout.PREFERRED_SIZE, 760, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblTituloTabela, javax.swing.GroupLayout.PREFERRED_SIZE, 353, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(16, Short.MAX_VALUE))
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(pnlTiposDeAlimento, javax.swing.GroupLayout.PREFERRED_SIZE, 738, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(14, 14, 14)
    ...
    private void btnVegetaisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVegetaisActionPerformed
        ...
        if (botao.equals("adicionar")){
            ...
            for (Estoque produto : listaDeProdutos) {
                if (!produto.getTipo().equals(tipoAlimentoSelecionado) ){
                    txtNome.setEnabled(false);
                    txtCodigo.setEnabled(false);
                    txtCusto.setEnabled(false);
                    snrQuantidade.setEnabled(false);
                    ...
                    txtValidade.setEnabled(false);
                    btnOk.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Não há itens desse tipo cadastrados no estoque.", "Messagem", JOptionPane.PLAIN_MESSAGE);
            }   else{
                    txtNome.setEnabled(false);
                    txtCodigo.setEnabled(true);
                    txtCusto.setEnabled(false);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtCodigo.getText().equals("") ||txtUnidade.getText().equals("") ||txtNome.getText().equals("") || cbxUnidade.getSelectedItem().equals("") || snrQuantidade.getValue().equals(0) || txtCusto.getText().equals("") || txtValidade.getText().equals("")) {
            ...
            if (botao.equals("adicionar")) {
                ...
                listaDeProdutos.get(index).setCodigo(codigo);
                listaDeProdutos.get(index).setNomeProduto(nome);
                listaDeProdutos.get(index).setUnidade(unidade);
                listaDeProdutos.get(index).setQuantidade(quantidade);
                listaDeProdutos.get(index).setValidade(validade);
                listaDeProdutos.get(index).setCusto(custo);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if (txtCodigo.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "O codigo deve ser informado", "Messagem", JOptionPane.PLAIN_MESSAGE);
        }
        else {
            Estoque est;
            String tipoAlimento = obterTipoAlimentoSelecionado(), nome = "", unidade="", objUnidade= "", textoUnidade = "",
                quantidade = "",custo = "", validade= "", codigo ="";
            
            
            int cod = Integer.parseInt(txtCodigo.getText());
            
            for (int i =0; i <listaDeProdutos.size(); i++) {
                est = listaDeProdutos.get(i);
                
                if (cod == est.getCodigo() && est.getTipo().equals(tipoAlimento)) {
                    
                    unidade = est.getUnidade();
                    String[] partesUnidade = unidade.split(" ");
                  
                    objUnidade =  partesUnidade[1];
                    textoUnidade =partesUnidade[0];
                    nome = est.getNomeProduto();
                    
                    
                    quantidade = String.valueOf(est.getQuantidade());
                    validade = est.getValidade();
                    custo =  String.valueOf(est.getCusto());
                    codigo =  String.valueOf(est.getCodigo());
            
                }
            }
        if (codigo.equals("")) {
            JOptionPane.showMessageDialog(null, "O codigo informado nao existe", "Messagem", JOptionPane.PLAIN_MESSAGE);
            txtNome.setText("");
            cbxUnidade.setSelectedItem(null);
            txtUnidade.setText("");
            txtValidade.setText("");
            ...
            cbxUnidade.setSelectedItem(objUnidade);
            txtUnidade.setText(textoUnidade);
            txtValidade.setText(validade);
            txtCusto.setText(custo);
            txtCodigo.setText(codigo);
            snrQuantidade.setValue(quantidade);
